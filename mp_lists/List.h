...
class List {
  private:
    ...
    typename List<T>::ListNode*&_index_helper(int index, ListNode *& node);
    typename List<T>::ListNode* min_node(ListNode * first, ListNode* second);
    typename List<T>::ListNode* max_node(ListNode * first, ListNode* second);
  public:
